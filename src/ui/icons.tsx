...
const paths = {
  ...
  bug: (
    <>
      <path d="M8 8a4 4 0 0 1 8 0v4a4 4 0 0 1-8 0z" />
      <path d="M4 10h4M16 10h4M4.5 16h3.7M15.8 16h3.7M6.5 5.5l2 2M17.5 5.5l-2 2M12 16v4" />
    </>
  ),
  quote: (
    <>
      <path d="M9.5 6.5C7 7.5 5.5 9.8 5.5 12.5V17h5v-5H8c0-1.7.6-3 1.5-3.6z" />
      <path d="M18 6.5c-2.5 1-4 3.3-4 6V17h5v-5h-2.5c0-1.7.6-3 1.5-3.6z" />
    </>
  ),
  error: (
    <>
