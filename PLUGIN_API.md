...
| Example | Shows |
|---|---|
| [hello-world](docs/plugin-api/examples/hello-world/) | The smallest working plugin |
| [word-count](docs/plugin-api/examples/word-count/) | A status-bar item that tracks the active note |
| [command](docs/plugin-api/examples/command/) | Registering commands with shortcuts |
| [sidebar](docs/plugin-api/examples/sidebar/) | A panel that lists notes by tag |
| [metadata](docs/plugin-api/examples/metadata/) | Reading links and writing frontmatter |
| [editor](docs/plugin-api/examples/editor/) | Transforming the text being edited |

Copy any of them into your vault's `.inner-empire/plugins/` folder and reload
the app.
